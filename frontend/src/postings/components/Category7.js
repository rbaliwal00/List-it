            ...
            <form onSubmit={formSubmit}>
                <div>
                    ...
                    <ul>
                            ...
                            type="radio"
                            id="v1"
                            name="v1">antiques - by dealer</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/appliances/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>appliances- by dealer</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/arts-crafts/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>arts & crafts - by dealer</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/atvs-utvs-snowmobiles/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>atvs, utvs, snowmobiles - by dealer</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/auto-parts/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>auto parts - by dealer</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/auto-wheels-tires/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>auto wheels & tires - by dealers</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/aviation/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>aviation - by dealer</InputList></NavLink>
                            <NavLink to={`/${location} /${categoryType}/baby-kid-stuff/saleform`}><InputList
                            element="input"
                            value="2"
                            type="radio"
                            change={onValueChange}>baby & kid stuff - by dealer</InputList></NavLink>
