            ...
            <div className="mh">
                ...
                <MainHeader>
                    <nav className="unwanted-nav">
                        <p style={{fontSize: '16px'}}>India > {props.city} > {props.type} > {props.form} ></p>
                    </nav>
                </MainHeader>
                    ...
                    <div className="row justify-content-center" style={{ margin: '5px 10px 10px 0'}}>
                        <div className="col-lg-5">
                            {props.rent && (<div className="row">
                                ...
                                <div className="col-8">
                                    <h6 style={{fontWeight: 'bolder'}}>{props.title} <span className="titleCity"> ({props.city.toUpperCase()})</span></h6>
                                </div>
                            </div>)}
